    ...
    <MainLayout>
      <div className="pb-20">
        ...
        <section className="p-6">
          <h2 className="text-lg font-bold text-[var(--text-primary)] mb-4">プロフィール</h2>
        ...
        <section className="px-6 pb-6">
          <h2 className="text-lg font-bold text-[var(--text-primary)] mb-4">パスワード変更</h2>
        ...
        <section className="px-6 pb-6">
          <h2 className="text-lg font-bold text-[var(--text-primary)] mb-4">通知設定</h2>
        ...
        {/* Danger Zone Section */}
        <section className="px-6 pb-6">
          <h2 className="text-lg font-bold text-[var(--text-primary)] mb-4">アカウント管理</h2>
